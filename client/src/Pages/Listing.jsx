  ...
  return (
    <>
      <main className="p-3 max-w-4xl mx-auto mb-5" >
        ...
        <form action="" className="flex flex-col sm:max-w-[80%] mx-auto lg:max-w-none lg:flex-row gap-6">
          ...
          <div className="flex flex-col flex-1 gap-4 mt-3 lg:mt-0">
            ...
            <div className="flex gap-4">
                <input type="file" id="images" className="border-gray-300 p-3 rounded w-full border" accept="images/*" multiple />
                <button className="p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80">Upload</button>
            </div>
          <button className="p-3 bg-slate-700 rounded-lg text-white uppercase hover:opacity-95 dispabled:opacity-60 ">Create listing</button>
          </div>
